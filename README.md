Casey complete manual/guide for the readme file.
Casey to addcomments in the FLashcards java page.
Sishir to add 20 Q for each test bank Literacy. Level 1 will have upper/lower case letter association. Level 2 will have fill in the blank word completion/sequencing.
Sishir to add comments in java files for firebase and literacy quizzes
SOJung to add comments on text to speech and math quizzes
Sojung looking into video add for > 15/20 q's correct as reward. different videos per quiz bank (4)/add comments in if successful
Text to speech completed, to be checked across both subjects.
Overall test of app through the emulator
